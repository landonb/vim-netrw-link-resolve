" FIXME/2020-03-21: This is a *TEMPORARY FILE*!
" - (lb): I copied this from Vim source (v8.2, at runtime/autoload/netrw.vim)
"   to vim-netrw-link-resolve to patch a typo. See `FncRef`, below, which in
"   places was typoed `Fncref` -- which is funny, because the lines at fault
"   were committed by Bram Moolenaar on 2015-01-07, which suggests to me no
"   one uses the `g:Netrw_funcref` feature as a List, just me, ha!.
